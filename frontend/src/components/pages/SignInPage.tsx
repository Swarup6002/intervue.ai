...
export default function SignInPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-primary/20 to-secondary/20 dark:from-background dark:via-primary/10 dark:to-secondary/10 text-gray-900 dark:text-white flex items-center justify-center p-8 relative overflow-hidden transition-colors duration-300">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  required
                  className="pl-12 bg-secondary/10 border-transparent dark:border-white/10 text-gray-900 dark:text-white placeholder:text-gray-500 focus:border-accent/50 focus:ring-accent/20 rounded-lg h-12"
                />
              </div>
            </div>
