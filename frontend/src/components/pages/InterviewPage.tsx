...
const PERSONAS = [
  ...
  { id: 'male_in', name: 'Rohan (Senior Dev - IN)', gender: 'male', lang: 'en-IN', pitch: 1.0, rate: 1.05 },
];
...
export default function InterviewPage() {
    ...
    const startInterview = async () => {
        ...
        } catch (e) { alert("Error connecting to backend."); setIsLoading(false); }
    };
    ...
    return (
        <div className="relative min-h-screen bg-[#020617] text-white overflow-hidden font-sans selection:bg-purple-500/30">
            <MeteorCanvas />
